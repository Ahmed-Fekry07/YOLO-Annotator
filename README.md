...
## 📸 Screenshot
   ...
   **Dataset Credit:** Side-scan sonar imagery from [AI4Shipwrecks]([(https://github.com/umfieldrobotics/ai4shipwrecks)](https://github.com/umfieldrobotics/ai4shipwrecks)) repository.
